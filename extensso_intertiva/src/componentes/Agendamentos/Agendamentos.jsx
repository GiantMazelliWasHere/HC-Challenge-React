                ...
                <div className="exames">
                    <div>
                        ...
                        <button className="botao">
                            <img src="C:\Users\mazelli\Desktop\hc\extensso_intertiva\Imagens\coleta.jpg" className="image"/>
                        </button>
                    </div>
                    <div>
                        Raio-X
                        <br/>
                        <button className="botao">
                            <img src="C:\Users\mazelli\Desktop\hc\extensso_intertiva\Imagens\raiox.jpg" className="image"/>
                        </button>
                    </div>
                    <div>
                        Ultrassom
                        <br/>
                        <button className="botao">
                            <img src="C:\Users\mazelli\Desktop\hc\extensso_intertiva\Imagens\ultrassom.jpg" className="image"/>
                        </button>
                    </div>
                </div>
